...
const flamePathIcon = (
  <>
    {/* Outline Path (Slightly Larger for Outline Effect) */}
    <path
...
// Flame icon with a gradient fill and yellow outline
            ...
            >
              <div className="relative mb-6 flex items-center justify-center w-48 h-48">
                ...
                >
                  ...
                  <g fill="url(#flameGradient)">{flamePath}</g>
                </svg>
              ...
              <p className="text-gray-500 text-normal">
                Water other people&apos;s plants for a week straight for bonus
                points (or show off that streak)!
              </p>
            </motion.div>
          </motion.div>
        )}
